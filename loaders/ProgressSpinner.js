...
exports.default = ProgressSpinner;
...
function ProgressSpinner(props) {
  ...
  var options = {
    ...
    radius: getRadius(props === null || props === void 0 ? void 0 : props.radius) || 300,
    completeMessage: (props === null || props === void 0 ? void 0 : props.completeMessage) || "Done!",
    accent: (props === null || props === void 0 ? void 0 : props.accentColor) || 'orange'
  ...
  }, isNaN((size / received * 100).toFixed(0)) ? 0 : (size / received * 100).toFixed(0), /*#__PURE__*/_react.default.createElement("span", {
    style: {
      fontWeight: "bold",
      position: "relative"
    }
  ...
  }, props.percent || 0, /*#__PURE__*/_react.default.createElement("span", {
    style: {
      fontWeight: "bold",
      position: "relative"
    }
  ...
  var themes = {
    basic: {
      ...
      foreground: "0px solid ".concat(options.colorPrimary),
      accent: "".concat(options.accent)
    },
    outline: {
      background: "transparent",
      foreground: "2px solid ".concat(options.colorPrimary),
      accent: "".concat(options.accent)
    },
    minimal: {
      background: "transparent",
      foreground: "1px solid ".concat(options.colorPrimary),
      accent: "".concat(options.accent)
    }
    ...
    return (
      ...
      _react.default.createElement("div", {
        ...
        style: {
          ...
          width: "".concat(!complete ? "".concat(options.radius, "px") : "0px"),
          // turn second value back to 0 for animations
          height: "".concat(!complete ? "".concat(options.radius, "px") : "0px"),
          // turn second value back to 0 for animations
          position: "relative",
        ...
        className: "react-progress-spinner-dot-container",
        style: {
          height: "100%",
          width: "100%",
          position: "absolute",
          transform: "rotate(".concat((received / size).toFixed(1) * 360, "deg)"),
          transition: "all ".concat(options.smoothing, " linear")
        }
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: "react-progress-spinner-dot",
        style: {
          width: '5%',
          height: '5%',
          left: "".concat(50 - 2.5, "%"),
          borderRadius: '50%',
          position: 'absolute',
          background: "".concat(themes[options.theme].accent)
        }
      })), /*#__PURE__*/_react.default.createElement("div", {
        ...
        style: {
          ...
          width: "100%",
          height: "100%",
          background: "".concat(themes[options.theme].foreground),
          transition: "width ".concat(options.smoothing, " cubic-bezier(0.87, 0, 0.13, 1)"),
          borderRadius: "50%"
        }
      }, /*#__PURE__*/_react.default.createElement("div", {
        className: "react-progress-spinner-mask",
        style: {
          display: "flex",
          justifyContent: "center",
          background: "".concat(themes[options.theme].background),
